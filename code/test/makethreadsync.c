...
{
    int fourchettes = 0;
    sem_t protege_fourchette = { -1 };
    sem_t io_sem = { -1 };

    simple_args fabricant = { "Fabricant", &fourchettes, &protege_fourchette, &io_sem };
    simple_args nietzsche = { "Nietzsche", &fourchettes, &protege_fourchette, &io_sem };
    simple_args aristote = { "Aristote", &fourchettes, &protege_fourchette, &io_sem };

    sem_t_init(&protege_fourchette, FOURCHETTES_MIN);
    sem_t_init(&io_sem, 1);
